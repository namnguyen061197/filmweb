...
function DetailItem(props) {
    ...
    useEffect(() => {
        ...
        const fetchDataMovieOrTV = async() => {
            ...
            const similars = await tmdpApi.getSimilars(category, id)
            setData({
                cast : credits.cast, 
        ...
        <div className={`detail_item pt-5 ${themeMode.name}`}>
            {category === "person" ? 
                <div className="container person">
                    <div className="person_info text_color row">
                        <div className="col-3">
                            {
                                data.profile_path ? 
                                <img src={apiConfig.originalImgae(data.profile_path)} alt="person_img"/>
                ...
                <div className="movie_or_tv">
                    <div className="poster">
                        <img src={apiConfig.originalImgae(data.backdrop_path)} alt="background_img" />
                    </div>
                    ...
                    <div className="main_content">
                        <div className="container py-5">
                            <div className="row mt-5 pt-3">
                                <div className="col-5">
                                    <img style={{height:"100%"}} src={apiConfig.w500Image(data.poster_path)} alt="poster_img" />
                                </div>
                                <div className="col-7">
                                    <div className='info container'>
                                        <h1>{data.title || data.name}</h1>
                                        <div className='rating d-flex align-items-center my-5'>
                                            <div className='score me-2'>{data.vote_average ? (data.vote_average).toFixed(1) : ""}</div>
                                            <span>
                                                {(data.genres) && (data.genres).map((tag,idx) => <button type="button" className="btn btn-danger py-1 px-2 mx-2" key={idx}>{tag.name}</button>)}
                                            </span>
                                        </div>
                                        <p className='short_desc'>
                                            {data.overview}
                                        </p>
                                        <div className="actions my-5 d-flex align-items-center">
                                            <span className="heart">
                                                <i className="fa-solid fa-heart ms-2 me-2"></i>
                                            </span>
                        ...
                        <div className={`${themeMode.name} mt-5`} >
                            <div className="container py-5">
                                            ...
                                            if(video) {
                                                ...
                                                <SwiperSlide key={idx}>
                                                    <div className="videos_infor">
                                                        <iframe src={apiConfig.videoYoutube(video.key)} style={{width:"100%", height:"680px"}}/>
                                                    </div>
                                                </SwiperSlide>
                                                )
                                            }
                                ...
                                <div className="backdrops mt-5">
                                    ...
                                    <Swiper
                                        className="listSwiper mySwiper px-5"
                                        navigation={true}
                                        pagination={{
                                            dynamicBullets: true,
                                        }}
                                            ...
                                            if(backdrop) {
                                                ...
                                                <SwiperSlide key={idx}>
                                                    <div className="backdrop_infor">
                                                        <img src={apiConfig.originalImgae(backdrop.file_path)} />
                                                    </div>
                                                </SwiperSlide>
                                                )
                                            }
                                            ...
                                            if(poster) {
                                                ...
                                                <SwiperSlide key={idx}>
                                                    <div className="poster_img">
                                                        <img src={apiConfig.w500Image(poster.file_path)} />
                                                    </div>
                                                </SwiperSlide>
                                                )
                                            }
                                ...
                                <div className="reviews mt-5">
                                    <div className="title my-4">
                                        <h4 className="text_color">{`REVIEWS (${data.totalReviews})`}</h4>
                                        <span className="line"></span>
                                    </div>
                                    {data.reviews && data.reviews.splice(1,5).map((review,idx) => 
                                        <div className="review_item my-2 p-2 hover_color">
