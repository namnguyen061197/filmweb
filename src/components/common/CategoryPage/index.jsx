        ...
        <div className='category-page'>
            ...
            <div className='navbar container my-4 ps-3 d-flex justify-content-between'>
                ...
                <span>
                    {listType.map((type,idx) => 
                        <button 
                            className={`p-2 mx-2 btn fw-semibold text_color ${ activeType === type.label && "btn-danger" }`}
                            key={type.label}
            ...
            <div className='listData container'>
                ...
                <div className="d-grid py-2">
                    ...
                    >
                        {loadStatus ? <img className='ms-2' width="35px" height="35px" src={loadingImG} alt='imgloading' /> : "LOAD MORE"}
                    </button>
                </div>
            </div>
